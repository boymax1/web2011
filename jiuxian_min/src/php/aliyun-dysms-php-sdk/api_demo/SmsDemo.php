...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4G9jRigjtNiVpML23SAx"; // AccessKeyId

        $accessKeySecret = "G7P6m9WrsNca71f1IJnGhaZCVoF8yt"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($icon) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($icon['phoneNumber']);

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("HSF商城");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("登录验证码测试");
